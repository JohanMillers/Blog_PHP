        ...
        <div class="row">
            <div class="col ">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST" name="login">  
                    ...
                    <i class="icono icon-lock"></i> <label for="">Consatreña</label>
                        <input type="text" class="form-control" name="pass" id="pass" placeholder="Ingresa tu Consatreña">
                    </div>
